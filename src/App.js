...
class App extends Component {
  ...
  render() {
    const {activeTabId, randomImage, timer, score, isGameOver} = this.state
    ...
    return (
      <div className="bg-container">
        <ul className="navbar-section">
          ...
          <li className="header-sec">
            <p className="score-para" testid="score">
              Score: <span className="count-el">{score}</span>
            </p>
            <div className="timer-con">
              ...
              />
              <p className="time-el" testid="timer">
                {timer} sec
              </p>
            </div>
          </li>
        ...
        {isGameOver ? (
          <div className="scorecard-view" testid="scorecard">
